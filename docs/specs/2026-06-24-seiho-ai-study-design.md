...
- 紙資料の配布コスト・更新コストを削減
- 研修中に参加者がプロンプトをコピー → Geminiで即試せる体験（ChatGPTは参考として併記、2026-08-30方針転換：主催者の意向で「主にGoogleのAIを使う研修」に統一。詳細はStage A〜Dの実装経緯を参照）
...
- 大阪市生活保護施設連盟所属の施設職員
- AI経験者向け（生成AIを個人利用で触ったことがある方を想定。2026-08-30、主催者方針により「初級と中級の間」から変更）
